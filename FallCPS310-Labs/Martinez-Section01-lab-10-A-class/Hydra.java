...
public class Hydra {
    public static void main(String args[]) {
        ...
        while(headBag != null && headBag.getCurrentSize()!=0 && noOverflow ==true){
    ...
    public static boolean simulationStep(BagInterface<Integer> heads, BagInterface<String> work) {
        ...
        work.add("chop");
        if(heads.getCurrentSize()>25 || work.getCurrentSize()>25){
            result= false;
        }
        return result;
        ...
        if(remove>1){
            ...
            for(int i=0; i<remove; i++){
                ...
                work.add("chop");
                count++;
                /*if(heads.getFrequencyOf(remove)==count && heads.getCurrentSize()==remove){
                    heads.remove(remove);
                    //break;
                }*/
                ...
                /*if(i==2){
                    heads.remove(remove-1);
                    break;
                }*/
                
                /*if(heads.getCurrentSize()-1 == remove){
                    result =true;
                    break;
                }*
